...
export default function OverView({ title, subtitle, content, asideImg }) {
  return (
    <div>
      ...
      <div className='md:pl-[117px] md:pt-[91px] pt-[30px] md:h-[845px] relative'>
        <div className='max-w-[327px] md:max-w-0 mx-auto md:mx-0'>
          <h3 className='md:w-[680px] text-[#2E4E4C]
        ...
        <div className="md:absolute right-0 top-0 md:h-full
        md:w-[527px] h-[250px] mb-[30px] md:mb-0">
